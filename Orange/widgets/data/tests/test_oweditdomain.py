...
from AnyQt.QtCore import QItemSelectionModel, Qt, QItemSelection, QModelIndex
from AnyQt.QtWidgets import QAction, QComboBox, QLineEdit, \
    QStyleOptionViewItem, QDialog, QAbstractItemView, QWidget
...
from Orange.widgets.data.oweditdomain import (
    ...
    GroupItemsDialog, MassVariablesEditor, KeyValueEditor,
    DeleteKey, AddItem, SetValue, RenameKey, mass_key_value_transforms,
    CategoriesEditor)
...
class TestEditors(GuiTest):
    ...
    def test_discrete_editor_merge_action(self):
        ...
        w.categories_editor.merge_items.trigger()
